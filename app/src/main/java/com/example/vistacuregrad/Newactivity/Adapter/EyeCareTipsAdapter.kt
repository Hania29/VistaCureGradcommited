...
class EyeCareTipsAdapter(private val itemList: List<EyeCareTip>) :
    ...
    override fun getItemViewType(position: Int): Int {
        return when {
            ...
            itemList[position].isDisclaimer -> TYPE_DISCLAIMER
            else -> TYPE_ITEM
        }
    }
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        when (holder) {
            ...
            is DisclaimerViewHolder -> {
                holder.disclaimerTitle.text = "Disclaimer!"
                holder.disclaimerText.text = item.description
            }
        }
    }
    ...
    class DisclaimerViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val disclaimerTitle: TextView = itemView.findViewById(R.id.tvDisclaimerTitle)
        val disclaimerText: TextView = itemView.findViewById(R.id.tvDisclaimerText)
    }
}
